...
const stringsToNumbs = (numbers) => {
    let numberArray = strNums.map(elem => elem = parseInt(elem));
    return numberArray;
}
...
// weather array. Your function should return the following array ['Light Cloud', 'Heavy Cloud', 'Showers']
const weatherStates = weather.map(elem => elem.weather_state_name);
console.log(weatherStates)

// //find the id of the object in weather that has a min_temp of 15.915

const idealTemp = weather.filter( elem => elem.min_temp===15.915);
